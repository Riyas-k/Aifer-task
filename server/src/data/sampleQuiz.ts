...
export const sampleQuiz = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: ["Ag", "Fe", "Au", "Cu"],
      correctAnswer: 2,
      explanation: "Au is the chemical symbol for gold, derived from the Latin word for gold, 'aurum'."
    },
    {
    ...
    },
    {
      ...
      correctAnswer: 2,
      explanation: "Diamond is the hardest naturally occurring substance found on Earth, scoring 10 on the Mohs scale of mineral hardness."
    },
    {
      text: "Which element has the chemical symbol 'O'?",
      options: ["Gold", "Oxygen", "Osmium", "Oganesson"],
      correctAnswer: 4,
      explanation: "O is the chemical symbol for Oxygen, one of the most abundant elements in the Earth's atmosphere."
    },
    {
      text: "Who wrote 'Romeo and Juliet'?",
      options: ["Charles Dickens", "William Shakespeare", "Jane Austen", "Mark Twain"],
      correctAnswer: 1,
      explanation: "Romeo and Juliet was written by William Shakespeare, believed to have been written between 1591 and 1595."
    }
  ]
};